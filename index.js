...
function buildCommentaryPrompt() {
    ...
    // Construct the prompt with Persona Logic
    let personaBlock = '';
 ...
 * Now with Connection Profile switching support!
 */
async function generateCommentary(force = false) {
    ...
    try {
        ...
        // Always switch back to original profile if we switched
        ...
        <div class="inline-drawer">
            ...
            <div class="inline-drawer-content">
                ...
                <div class="kibitzer-setting-row">
                    ...
                    <textarea id="kibitzer-custom-prompt" class="text_pole" rows="4" 
                        placeholder="Leave empty to use default. Use this to customize how the character should comment."></textarea>
                </div>
